...
```bash
powershell.exe -Command "Start-Process 'cmd.exe' -ArgumentList '/k cd /d <repo_path> && pear run . -- --peer-store-name mnemex-node --msb-store-name mnemex-msb --sc-bridge-token mnemex-dev-token-2026 --sc-bridge-port 49222 --subnet-channel mnemex-v1 --subnet-bootstrap a5c9c46671b936fb15be80f7d89a093c99053104d58efc0b8369eb9207fd82cf --setup-only'"
```
...
```bash
powershell.exe -Command "Start-Process 'cmd.exe' -ArgumentList '/c cd /d <repo_path> && pear run . -- --peer-store-name mnemex-node --msb-store-name mnemex-msb --sc-bridge 1 --sc-bridge-port 49222 --sc-bridge-token mnemex-dev-token-2026 --sc-bridge-cli 1 --require-payment 1 --subnet-channel mnemex-v1 --subnet-bootstrap a5c9c46671b936fb15be80f7d89a093c99053104d58efc0b8369eb9207fd82cf --cortex-channels cortex-crypto,cortex-dev,cortex-general,cortex-trac --enable-skills 1' -WindowStyle Hidden"
```
